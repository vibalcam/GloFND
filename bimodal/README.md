...
We show how to use **Glo**bal **F**alse **N**egative **D**etection (*GloFND*) for *global contrastive learning* in the bimodal scenario. For this, we apply GloFND to FastCLIP and SogCLR.
...
1. Download this repository:
    ```bash
    git clone https://github.com/vibalcam/dev-fast-popnet.git
    ```
...
<details open>
    <summary>Sample script to run <b>FastCLIP</b> on CC3M using 4 GPUs (2 nodes and 2 GPUs per node)</summary>
...
<details>
    <summary>Sample script to run <b>SogCLR</b> on CC3M using 4 GPUs (click to expand):</summary>
